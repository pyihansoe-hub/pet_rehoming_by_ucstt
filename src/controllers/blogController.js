...
const createBlog = async (req, res) => {
  const { title, content, summary, category_id, cover_image_url, status = 'draft', tags = [] } = req.body;
...
const updateBlog = async (req, res) => {
  const { title, content, summary, category_id, cover_image_url, status, tags } = req.body;
